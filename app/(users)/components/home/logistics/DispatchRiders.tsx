...
import { toggleDispatch } from "@/app/(users)/store/logisticSlice";
...
const DispatchRiders = () => {
  ...
  // handle dispatch riders toggle
  const handleDispatchRiders = () => {
    ...
    >
      <div className="flex items-center justify-between gap-4 w-full md:w-auto">
        ...
        <motion.div
          ...
          animate={logistics.dispatch ? "down" : "up"}
